...
//VERIFICAR FUNCIONÁRIO
  static async FuncionarioLogin(req,res){
    ...
    const options = {
      url: 'https://apilivraria.dgkeven.repl.co/login',
      method: 'POST',
      data: valores 
    };
...
// CREATE FUNCIONÁRIO
  static async FuncionarioCreate(req,res){
    let valores = req.body;
    const options = {
      url: 'https://apilivraria.dgkeven.repl.co/add_funcionario',
      method: 'POST',
      data: valores 
    };
    axios(options);
...
// CREATE LIVRO
  static async LivroCreate(req,res){
    let valores = req.body;
    const options = {
      url: 'https://apilivraria.dgkeven.repl.co/add_livros',
      method: 'POST',
      data: valores 
    };
    axios(options);
...
// LISTAR
  static async LivroListar(req,res){
    const options = {
      url: 'https://apilivraria.dgkeven.repl.co/livros',
      method: 'GET',
      data: {}
    };
